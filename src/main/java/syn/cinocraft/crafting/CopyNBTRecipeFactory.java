package syn.cinocraft.crafting;
...
public class CopyNBTRecipeFactory implements IRecipeFactory {
    ...
    public IRecipe parse(JsonContext context, JsonObject json) {
        ...
        return new CopyNBTRecipe(new ResourceLocation(mymod.MODID, "copy_nbt_crafting"), recipe.getRecipeOutput(), primer);
    }
    ...
    public static class CopyNBTRecipe extends ShapedOreRecipe {
        ...
        public ItemStack getCraftingResult(@Nonnull InventoryCrafting var1) {
            ...
            for (int i = 0; i < var1.getSizeInventory(); ++i) {
                ...
                if (!stack.isEmpty()) {
                    if (stack.getItem() instanceof BlockCinoFurnace.INBTPreservingIngredient) {
                        itemstack = stack;
                    } else if (Block.getBlockFromItem(stack.getItem()) instanceof BlockCinoFurnace.INBTPreservingIngredient) {
                        itemstack = stack;
                    }
                }
            }
