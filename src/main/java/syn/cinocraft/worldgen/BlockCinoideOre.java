...
public class BlockCinoideOre extends Block {

        public static final PropertyEnum<OreType> ORETYPE = PropertyEnum.create("oretype", OreType.class);
        public static final ResourceLocation cinoide_ore = new ResourceLocation(mymod.MODID, "cinoide_ore");

        public BlockCinoideOre() {
            super(Material.ROCK);
            setHardness(3.0f);
            setResistance(5.0f);
