...
public class BlockCinoOre extends Block {

    public static final PropertyEnum<OreType> ORETYPE = PropertyEnum.create("oretype", OreType.class);
    public static final ResourceLocation cino_ore = new ResourceLocation(mymod.MODID, "cino_ore");
    ...
    public BlockCinoOre() {
        ...
        setUnlocalizedName(mymod.MODID + ".cino_ore");
        setRegistryName("cino_ore");
